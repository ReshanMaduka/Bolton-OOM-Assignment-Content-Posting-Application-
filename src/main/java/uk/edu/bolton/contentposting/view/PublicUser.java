...
public class PublicUser extends javax.swing.JFrame implements Observer {
   ...
   public PublicUser(String name, String channelName) {
        ...
        channelNameLbl.setText(this.channelName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PublicUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PublicUser().setVisible(true);
            }
        });
    }
