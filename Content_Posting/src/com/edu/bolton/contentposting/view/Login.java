...
public class Login extends javax.swing.JFrame {
    ...
    private void publicUserLoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_publicUserLoginBtnActionPerformed
        ...
        PublicUserTimeLine user = new PublicUserTimeLine(publicUserNameTxt.getText(),subscribeChannelNameTxt.getText());
        UserController.getInstance().addNewPublicUser(user);
        
        Group group = UserController.getInstance().findNewContentCreatorByName(subscribeChannelNameTxt.getText());
    ...
    private void channelLoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_channelLoginBtnActionPerformed
        ...
        UserController.getInstance().addNewContentCreator(grp);
